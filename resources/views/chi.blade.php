        ...
        <table class="w-2/5 border">
            ...
            <tbody class="py-5">
                @for ($i = 0; $i < $kelas; $i++) <tr class="bg-gray-100 text-center border-b text-base text-gray-600">
                    ...
                    <td class="p-2 border-r"> {{ $batasBawahBaru[$i] }}</td>
                    <td class="p-2 border-r"> {{ $batasAtasBaru[$i] }}</td>
                    <td class="p-2 border-r"> {{ $zBawah[$i] }}</td>
                    <td class="p-2 border-r"> {{ $zAtas[$i] }}</td>
                    <td class="p-2 border-r"> {{ $zTabelBawahFix[$i] }}</td>
                    <td class="p-2 border-r"> {{ $zTabelAtasFix[$i] }}</td>
                    <td class="p-2 border-r"> {{ $lprop[$i] }}</td>
                    <td class="p-2 border-r"> {{ $fe[$i] }}</td>
                    <td class="p-2 border-r"> {{ $kai[$i] }}</td>
                    </tr>
                    @endfor
                    <tr class="bg-gray-100 text-center border-b text-base text-gray-600">
                        ...
                        <th class="p-2 border-r"></th>
                        <th class="p-2 border-r"></th>
                        <th class="p-2 border-r">{{ $totalchi }}</th>
                    </tr>
            </tbody>
        </table>
    </div>

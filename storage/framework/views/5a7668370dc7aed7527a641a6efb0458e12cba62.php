        ...
        <table class="w-2/5 border">
            ...
            <tbody class="py-5">
                ...
                <tr class="bg-gray-100 text-center border-b text-base text-gray-600">
                    ...
                    <td class="p-2 border-r"><?php echo e($skor->skor); ?></td>
                    <td class="p-2 border-r"><?php echo e($skor->frekuensi); ?></td>
                </tr>
                <?php $no++ ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\lrvl-statistik\resources\views/frekuensi.blade.php ENDPATH**/ ?>